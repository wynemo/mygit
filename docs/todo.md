...
105. 995ecee 看这个提交 差异显示不正常 感觉少一个字符 估计是多行显示的问题
106. 提交历史，CustomTreeWidget - 右键点击item 如果说是item代表的分支与当前分支不一样，显示右键菜单checkout,然后二级菜单里是可以切换的分支，点击分支就切换;远程分支 merge功能
