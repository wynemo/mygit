from PyQt6.QtWidgets import (QWidget, QHBoxLayout, QPushButton, QComboBox, 
                             QMenu, QToolButton, QLabel, QApplication, QFrame)
...
if __name__ == '__main__':
    ...
    def request_toggle_panel():
        ...
        print(f"Button is checked: {current_panel_visibility}. Simulating panel visibility to be {current_panel_visibility}.")
